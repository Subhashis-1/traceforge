...
// TestDummy is a placeholder test to force compilation of the middleware.
func TestDummy(_ *testing.T) {
	// This test exists solely to verify the middleware compiles.
	// No actual assertions needed.
}
